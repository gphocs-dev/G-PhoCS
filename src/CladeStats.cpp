...
//	clade_stats[clade].coal_stats_total += genetree_stats[gen].coal_stats[clade];
	clade_stats[clade].coal_stats_total += calculateCoalStats(clade_stats[clade].elapsed_times + startingPoint, clade_stats[clade].num_lineages + startingPoint, clade_stats[clade].num_events - startingPoint);
